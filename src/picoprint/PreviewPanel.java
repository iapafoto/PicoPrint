...
public class PreviewPanel extends Container {
    ...
    public PreviewPanel(double cx1, double cy1, double r1, double cx2, double cy2, double r2, AffineTransform at, BufferedImage lineDrawn, Rectangle2D drawingArea) {
        this.cx1 = cx1;
        this.cy1 = cy1;
        this.cx2 = cx2;
        this.cy2 = cy2;
    ...
    public void paint(Graphics graphics) {
        ...
        if (lineDrawn != null) {
            ...
            g2.setComposite(ac);
            if (lineDrawn != null) {
                g2.drawImage(lineDrawn, at, this);
            }
